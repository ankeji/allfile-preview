...
/**
 * <file-preview-video> 视频预览（file-preview-player 的 video 形态薄壳）
 *
 * 属性与方法说明见 README；事件由内部 player 以 composed CustomEvent 冒泡透出，
 * 在本元素或任意祖先上 addEventListener 均可捕获。
 */
@customElement('file-preview-video')
export class FilePreviewVideo extends LitElement {
  @property() src = ''
  @property() name = ''
  @property() poster = ''
...
declare global {
  interface HTMLElementTagNameMap {
    'file-preview-video': FilePreviewVideo
  }
}
